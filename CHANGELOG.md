...
- **Tử Vi**: Sửa lỗi can của tháng lưu nguyệt (Tứ Hóa lưu nguyệt) không đi theo can của cung mà nó an vị (Tháng nào cung nấy). Giờ đây điểm Lưu niên từng tháng sẽ dùng đúng hệ Tứ Hóa của cung khởi tháng đó thay vì luôn nhận can của tháng Dần.
