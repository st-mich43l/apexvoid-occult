...
|--------|---------|-------|
| palace-overview | V1 numeric knowledge `1.3.0-experimental`, engine `1.3.0` | Score = net quality after empirical offset. Scoring calibration **NO_GO** until expert labels. See `modules/palace-overview/README.md`. |
