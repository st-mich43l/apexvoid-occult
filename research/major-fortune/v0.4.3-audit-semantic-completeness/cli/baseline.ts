/**
 * Major Fortune V0.4.3 Baseline Generator.
 *
 ...
 *
 * Usage:
 *   npx tsx research/major-fortune/v0.4.3-audit-truthfulness/cli/baseline.ts --accept-baseline-update
 */
...
const ROOT = resolve(process.cwd(), "research/major-fortune/v0.4.3-audit-truthfulness");
...
function run(): void {
  ...
  const manifest: BaselineManifest = {
    ...
    generatedByScript: "research/major-fortune/v0.4.3-audit-truthfulness/cli/baseline.ts",
