...
class TemporalSnapshotBundle(BaseModel):
  """Foreign-year ChartDTO snapshots generated by TypeScript Calculation Core.

  Anchor chart is NOT duplicated here. Max 5 snapshots; at least 1 when present.
  """
  anchorAnnualYear: int
  snapshots: list[ChartDTO] = Field(min_length=1, max_length=5)
...
class InterpretRequest(BaseModel):
  ...
  # PR #250 — optional multi-year Calculation Core snapshots (foreign years only)
  temporalSnapshots: Optional[TemporalSnapshotBundle] = None
